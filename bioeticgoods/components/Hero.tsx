      ...
      <div className="flex lg:flex-row lg:max-w-5xl items-center mx-auto">
        ...
        >
          ...
          <p className="font-light w-3/4 xsm:text-sm lg:text-base text-gray-600 mt-8">
            Agiamo come broker e distributore nel settore alimentare e delle
            bevande. Siamo specializzati in prodotti secchi, freschi e
            congelati, vino e liquori, spezie ed erbe.
          </p>
          <div className="mt-4">
            <button
            ...
            >
              <div className="flex flex-row items-center">
                ...
                <p className="ml-1 xsm:text-sm lg:text-base">Chi siamo</p>
              </div>
            </button>
            <button
            ...
            >
              <div className="flex flex-row items-center">
                ...
                <p className="ml-1 xsm:text-sm lg:text-base">Contatta</p>
              </div>
            </button>
          </div>
          <div className="mt-8">
            <p className="text-gray-600 font-light text-sm">
              Operiamo nelle seguenti regioni:
            </p>
